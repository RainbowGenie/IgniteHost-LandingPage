...
const Faqs = () => {
  return (
    <div className={s.root}>
      <p className="font-space-grotesk font-bold text-5xl mb-10">
      ...
      <div className="w-3/5 flex flex-col items-start gap-4">
        <div
          className={cn(
            s.faqWrapper,
            "rounded-md py-6 pl-8 font-space-grotesk font-bold text-xl w-full"
          )}
        >
        ...
        >
          ...
          <p className="font-space-grotesk font-normal text-lg mt-5">
